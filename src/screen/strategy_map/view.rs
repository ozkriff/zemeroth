...
pub struct Images {
    ...
    pub white_hex: Image,
    pub tile: Image,
    pub tile_rocks: Image, // TODO: replace with water
    pub grass: Image,
    pub dot: Image,
    pub blood: Image,
    pub shadow: Image,
...
fn make_action_grass(view: &View, at: PosHex) -> ZResult<Box<dyn Action>> {
    let screen_pos = hex_to_point(view.tile_size(), at);
...
pub fn make_action_create_map(state: &State, view: &View) -> ZResult<Box<dyn Action>> {
